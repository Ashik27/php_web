...
//$total_post=mysqli_fetch_array($result,MYSQLI_ASSOC);
...
<head>
    ...
    <title>RejuvSense Admin Dashboard</title>
...
?>
	 ...
	 <tbody>
        <tr class="gradeC">
			...
			<td><?php echo $desc; ?></td>
			<td class="center"><a href="post_edit.php?edit=<?php echo $post_id;?>"><button type="button" class="btn btn-success disabled"><span class="fa fa-pencil">&nbsp;</span>Edit</button></a></td>
			<td><a href="post_delete.php?del=<?php echo $post_id;?>"><button type="button" class="btn btn-success"><span class="fa fa-trash-o">&nbsp;</span>Delete</button></a></td>
		</tr>
 </tbody>
